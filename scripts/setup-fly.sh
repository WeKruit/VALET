...
HATCHET_APP="valet-hatchet${SUFFIX}"
...
echo "║  Web:     ${WEB_APP}                       "
echo "║  Hatchet: ${HATCHET_APP}                   "
echo "╚══════════════════════════════════════════╝"
echo ""

# ── Create apps ──
for APP in "$API_APP" "$WORKER_APP" "$WEB_APP" "$HATCHET_APP"; do
...
echo "    HATCHET_CLIENT_TOKEN=\"your-hatchet-token\" \\"
echo "    HATCHET_CLIENT_TLS_STRATEGY=\"tls\" \\"
...
echo "    OPENAI_API_KEY=\"your-openai-key\""
echo ""
echo "─── Required secrets for Hatchet (${HATCHET_APP}) ───"
echo ""
echo "  fly secrets set -a ${HATCHET_APP} \\"
echo "    DATABASE_URL=\"your-supabase-connection-string\" \\"
echo "    SERVER_TASKQUEUE_RABBITMQ_URL=\"your-cloudamqp-url\" \\"
echo "    SERVER_AUTH_COOKIE_DOMAIN=\"${HATCHET_APP}.fly.dev\" \\"
echo "    SERVER_AUTH_COOKIE_INSECURE=\"false\" \\"
echo "    SERVER_GRPC_BIND_ADDRESS=\"0.0.0.0\" \\"
echo "    SERVER_GRPC_BROADCAST_ADDRESS=\"${HATCHET_APP}.fly.dev:7077\" \\"
echo "    SERVER_GRPC_PORT=\"7077\""
echo ""
...
echo "  fly deploy --config fly/hatchet.toml --app ${HATCHET_APP} --remote-only"
