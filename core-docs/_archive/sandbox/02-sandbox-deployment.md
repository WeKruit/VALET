...
> **Note (updated 2026-02):** This document describes the Fly Machines ephemeral sandbox model,
> which has been **deferred to V2**. The MVP uses persistent EC2 instances with AdsPower + Selenium,
> deployed via Terraform/Ansible. See [`03-ec2-worker-integration.md`](03-ec2-worker-integration.md)
> for the current deployment architecture. This doc is retained for V2 reference when transitioning
> to ephemeral sandboxes with Stagehand/Magnitude browser agents.
