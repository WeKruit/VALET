...
>
> Magnitude integration is deferred until V2. The MVP uses Selenium via AdsPower for browser
> automation. Magnitude will be integrated as the vision-first fallback agent when Stagehand's
> DOM approach fails on complex UIs.
