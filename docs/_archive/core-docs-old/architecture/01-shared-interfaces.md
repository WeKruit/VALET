...
_Depends on: [automation.ts](../../packages/shared/src/types/automation.ts), [task.schema.ts](../../packages/shared/src/schemas/task.schema.ts), [user.schema.ts](../../packages/shared/src/schemas/user.schema.ts)_
_Consumed by: [04-engine-switching.md](../integration/04-engine-switching.md), [04-multi-tier-sandbox-architecture.md](../sandbox/04-multi-tier-sandbox-architecture.md)_
