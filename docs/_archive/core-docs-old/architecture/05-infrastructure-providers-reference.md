...
| _(all other create params)_ | --     | NO       | Any field from create  |
...
_Sources: [AdsPower Local API Docs](https://localapi-doc-en.adspower.com/), [Browserbase Docs](https://docs.browserbase.com/), [AdsPower GitHub](https://github.com/AdsPower/localAPI)_
_Depends on: [01-adspower-integration.md](../integration/01-adspower-integration.md), [04-multi-tier-sandbox-architecture.md](../sandbox/04-multi-tier-sandbox-architecture.md)_
