...
_Depends on: [task.schema.ts](../../packages/shared/src/schemas/task.schema.ts), [01-shared-interfaces.md](01-shared-interfaces.md)_
_Consumed by: Worker implementation, Frontend progress UI, API task service_
