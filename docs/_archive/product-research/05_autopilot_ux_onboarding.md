...
_End of Autopilot & Copilot Mode Selection, Onboarding, and Trust UX specification. This document should be reviewed alongside 02_user_flows_and_ux_design.md for the complete design system, as this document extends and partially revises the onboarding and settings flows defined there._
