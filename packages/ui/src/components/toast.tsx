...
const toastVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default: "bg-[var(--wk-surface-white)] text-[var(--wk-text-primary)]",
        success: "bg-emerald-50 text-[var(--wk-status-success)] border-emerald-200",
        warning: "bg-amber-50 text-[var(--wk-status-warning)] border-amber-200",
        destructive: "bg-red-50 text-[var(--wk-status-error)] border-red-200",
      },
    },
    defaultVariants: {
      variant: "default",
